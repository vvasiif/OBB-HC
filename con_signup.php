...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    $query = "insert into users (username,email,password,phone,city,gender,role,qualification,file) 
    value ('$username','$email','$password','$phone','$city','$gender','$role','$qualification','$file')";
