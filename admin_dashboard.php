...
<body>
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
            <a href="admin_brlist.php"><button type="button" class="btn-large">Blood Requests (<?php echo $brl ?>)</button></a>
            </div>
            <div class="col-lg-6">
            <a href="admin_bdlist.php"><button type="button" class="btn-large">Blood Donors (<?php echo $bdl ?>)</button></a>
            </div>
